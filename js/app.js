...
function initSliders() {
  if (document.querySelector('.slider-detail-page')) {
    const thumbsSlider = new Swiper('.thumbs-slider-page__slider', {
      observer: true,
      observeParents: true,
      speed: 600,
      loop: true,
    ...
    new Swiper('.slider-detail-page__slider', {
      modules: [Thumb, Zoom],
      observer: true,
      observeParents: true,
      slidesPerView: 1,
  ...
  if (document.querySelector('.products-slider')) {
    new Swiper('.products-slider__slider', {
      ...
      navigation: {
        prevEl: '.products-slider .arrows-slider__arrow_prev',
        nextEl: '.products-slider .arrows-slider__arrow_next',
      },
      breakpoints: {
        320: {
          slidesPerView: 1,
...
function documentActions(e) {
  ...
  if (targetElement.closest(".catalog-header__button")) {
    const parentElement = targetElement.closest(".catalog-header");
    parentElement.classList.toggle("_show-catalog");
  }
};
